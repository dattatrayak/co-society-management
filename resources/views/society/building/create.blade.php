    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <form action="{{ route('society.building.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="flat_count" id="flat_count"
                                            value="{{ old('flat_count') }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-3">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="flat_no_start" id="flat_no_start"
                                            value="{{ old('flat_no_start') }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="flat_per_floor" id="flat_per_floor"
                                            value="{{ old('flat_per_floor') }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-3">
                                    <div class="form-group">
                                ...
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cctv" id="cctv" value="{{ old('cctv') }}"
                                            class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-3">
