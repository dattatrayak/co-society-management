...
<div class="container-fluid px-4">
    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <form action="{{ route('admin.society-user.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row border border rounded m-2 p-3 ">
                    <div class="col-12">
                ...
                <div class="row layout-border g-3">
                    <div class="col-12 col-lg-4">
                        <div class="card  border h-100">
                            <div class="card-body">
                                <h4 class="card-title mb-3">Society Login</h4>
                                <div class="mb-3">
                                    <div class="row ">
                                        <div class="form-group">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8">
                        <div class="card border h-100">
                            <div class="card-body">
                                <h4 class="card-title mb-3">Society Images</h4>
