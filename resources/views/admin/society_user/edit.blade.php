    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <form action="{{ route('admin.society-user.update', $societyUser->id) }}" method="POST"
                                        ...
                                        <div class="upload_gallery" id="previewGallery1">
                                            ...
                                            @if ($societyUser->logo)
                                                <div class="img-container">
                                                    <img src="{{ asset('storage/uploads/society/logo/' . $societyUser->logo) }}"
                                                        width="200">
                                                </div>
                                            @else
                                        ...
                                        <div class="col-6">
                                            <div class="upload_gallery" id="previewGallery2">
                                                @if ($societyUser->society_image)
                                                    <div class="img-container">
                                                        <img src="{{ asset('storage/uploads/society/img/' . $societyUser->society_image) }}"
                                                            width="200">
                                                    </div>
                                                @else
                                                    <div class="show-img-wrapper"> Preview image...</div>
